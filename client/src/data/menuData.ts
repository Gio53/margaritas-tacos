...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Steak (Top Sirloin)", price: 16.00 },
      { name: "Pastor", price: 16.00 },
      { name: "Carnitas", price: 16.00 },
      { name: "Shrimp", price: 16.00 },
      { name: "Chorizo", price: 16.00 },
      { name: "Tinga (Spicy Chicken)", price: 15.00 },
      { name: "Vegan Rice Bowl", price: 15.00, isVegan: true, note: "Black beans, lettuce, pico de gallo, guacamole, mushrooms, green peppers, onions" },
    ],
  },
  {
    id: "burrito",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Shrimp", price: 16.00 },
      { name: "Chorizo", price: 16.00 },
      { name: "Ground Beef", price: 15.00 },
      { name: "Tinga (Spicy Chicken)", price: 15.00 },
      { name: "Vegan Burrito", price: 15.00, isVegan: true, note: "Black beans, lettuce, pico de gallo, guacamole, mushrooms, green peppers, onions" },
    ],
  },
  {
    id: "nachos",
