  ...
  const handleAddTestOrder = async () => {
    ...
    try {
      await addOrder({
        ...
        items: [
          {
            categoryName: "Mexican Street Tacos",
            itemName: "Grilled Chicken",
            quantity: 1,
            removeIngredients: ["Guacamole"],
            addExtras: [{ name: "Sour Cream", price: 2, quantity: 1 }],
            lineTotal: 7.0,
          },
          {
            categoryName: "Nachos",
            ...
            quantity: 1,
            removeIngredients: ["Pico de gallo"],
            addExtras: [{ name: "Sour Cream", price: 2, quantity: 1 }],
            lineTotal: 15.0,
          },
          {
            ...
            quantity: 1,
            removeIngredients: ["Rice & beans"],
            addExtras: [{ name: "Guacamole", price: 3, quantity: 1 }],
            lineTotal: 17.0,
          },
        ],
        subtotal: 39.0,
